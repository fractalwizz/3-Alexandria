...
public class AlexandriaContract {
    ...
    public static final class BookEntry implements BaseColumns {
        ...
        public static Uri buildBookUri(long id) { return ContentUris.withAppendedId(CONTENT_URI, id); }

        public static Uri buildFullBookUri(long id) { return ContentUris.withAppendedId(FULL_CONTENT_URI, id); }
    }
    ...
    public static final class AuthorEntry implements BaseColumns {
        ...
        public static Uri buildAuthorUri(long id) { return ContentUris.withAppendedId(CONTENT_URI, id); }
    }
    ...
    public static final class CategoryEntry implements BaseColumns {
        ...
        public static Uri buildCategoryUri(long id) { return ContentUris.withAppendedId(CONTENT_URI, id); }
    }
}